...
action_set.scroll_previewer = function(prompt_bufnr, direction)
  ...
  local default_speed = vim.api.nvim_win_get_height(status.layout.preview.winid)
...
action_set.scroll_results = function(prompt_bufnr, direction)
  local status = state.get_status(prompt_bufnr)
  local default_speed = vim.api.nvim_win_get_height(status.layout.results.winid)
  local speed = status.picker.layout_config.scroll_speed or default_speed
